...
const basicStyle =
  "block py-1 px-1 m-3 text-red-100 text-4xl font-bold tracking-widest nav-selection transform ";
...
export default function Navigation() {
  return (
    <header className="h-full bg-blackNavi z-50 w-auto md:h-auto md:w-screen md:p-2 fixed top-0">
            ...
            {NavigationSections.map((sect) => (
              ...
              >
                <div className="flex">
                  ...
                  <span className="md:ml-5">{sect.image}</span>
                </div>
              </NavLink>
            ))}
          </div>
